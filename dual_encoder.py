...
class Encoder(nn.Module):
    ...
    def init_weights(self):
        ...
        glove_embeddings = preprocess_data.load_glove_embeddings(self.vocab)
    ...
    def att_on_embedding(self, contexts, responses, c_tf_idf, r_tf_idf): #dim context:b*seq  response:b*seq
        ...
        contexts_emb = self.embedding(contexts)     #dim: b*seq*emb_dim<--b*seq
        responses_emb = self.embedding(responses)   #dim: b*seq*emb_dim<--b*seq
